...
export default {
  ...
  computed: {
    meterb() {
      this.tableData01 = this.$store.getters.hot;

      this.tableData[0].te1 = this.tableData01[0].TE1;
      this.tableData[0].te2 = this.tableData01[0].TE2;
      this.tableData[0].pt1 = this.tableData01[1].PT1;
      this.tableData[0].pt2 = this.tableData01[0].PT2;
      this.tableData[0].ft1 = this.tableData01[0].FT1;
      this.tableData[0].time = this.tableData01[0].Stime;
      this.tableData[0].date = this.tableData01[0].Sdate;
      this.tableData[0].count = (
        (this.tableData01[0].FT1 *
          (this.tableData01[0].TE1 - this.tableData01[0].TE2) *
          4.1868) /
        1000 /
        3.6
      ).toFixed(2);
