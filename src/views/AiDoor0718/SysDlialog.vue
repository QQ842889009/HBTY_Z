  ...
  <div class="dialog-consumer">
    ...
    >
      ...
      >
        ...
        <el-form-item label="集中器号" prop="concentratorCode">
          <el-input v-model="ruleForm.concentratorCode"></el-input>
        </el-form-item>
        <el-form-item label="户阀号" prop="valveCode">
