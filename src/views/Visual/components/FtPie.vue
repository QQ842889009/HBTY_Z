  ...
  methods: {
    init() {
      ...
      this.option = {
        ...
        series: [{
              name: this.btnsList.name,
              type: this.seriesType,
              encode: { x: "站点", y: (this.btnsList.value) },
        }],
        /*  series: (function(){
           var series = [];
           ...
           do {
             var item = {
               name: this.title_btns[index].name,
               type: this.seriesType,
               datasetIndex: 1,
               encode: { x: "Station", y: (this.title_btns[index].logo) },
 
             }
             index++;
             series.push(item);
           } while (index < this.title_btns.length - 1);
           return series;
         })(), */
        /* series(){
        ...
        /*  series: [
           {
             type: this.seriesType,
             name: "供水压力", //this.getSeriesName(this.title_name)[0],
             datasetIndex: 1,
             encode: { x: "Station", y: "TE11" },
           },
           {
             type: this.seriesType,
             name: "回水压力", //this.getSeriesName(this.title_name)[1],
             datasetIndex: 1,
