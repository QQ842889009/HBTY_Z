<template>
  <div class="card" :style="{ width: this.width, height: this.height }">
    ...
    <el-row type="flex" class="row-bg" justify="center">
      ...
      <el-col :span="6">
        <div class="grid-content bg-purple">二供压力高高限</div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-input
            v-model="allData.PT21HH"
      ...
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-switch
            ...
            active-text="开"
            inactive-text="关"
            @change="changept21Lock($event)"
          >
          </el-switch>
        </div>
      </el-col>
      <el-col :span="4">
        <div class="grid-content bg-purple">停循环泵</div>
      </el-col>
    </el-row>
    ...
    <el-row type="flex" class="row-bg" justify="center">
      ...
      <el-col :span="6">
        <div class="grid-content bg-purple">二回压力低低限</div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-input
            :disabled="!ISAUTH.isAUth(['ROOT', 'DATA:ADMIN', 'DATA:UPDATE'])"
            v-model="allData.PT22LL"
            @focus="getInputFocus($event)"
            oninput="value=value.replace(/[^0-9.]/g,'');if(value>1.6){value=1.6}"
            :controls="false"
    ...
    <el-row type="flex" class="row-bg" justify="center">
      <el-col :span="6">
        <div class="grid-content bg-purple">二回压力高高限</div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-input
            :disabled="!ISAUTH.isAUth(['ROOT', 'DATA:ADMIN', 'DATA:UPDATE'])"
            v-model="allData.PT22SP_HH"
            @focus="getInputFocus($event)"
            oninput="value=value.replace(/[^0-9.]/g,'');if(value>1.6){value=1.6}"
            :controls="false"
      ...
      <el-col :span="4">
        <div class="grid-content bg-purple">停补水泵</div>
      </el-col>
    </el-row>
    ...
    <el-row type="flex" class="row-bg" justify="center">
      <el-col :span="6">
        <div class="grid-content bg-purple">1#循环泵泵停泵</div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-switch
            :disabled="!ISAUTH.isAUth(['ROOT', 'DATA:ADMIN', 'DATA:UPDATE'])"
            v-model="allData.bp21a_lock"
            :width="60"
            :active-value="1"
            :inactive-value="0"
            active-color="#13ce66"
    ...
    <el-row type="flex" class="row-bg" justify="center">
      <el-col :span="6">
        <div class="grid-content bg-purple">2#循环泵泵停泵</div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-switch
            :disabled="!ISAUTH.isAUth(['ROOT', 'DATA:ADMIN', 'DATA:UPDATE'])"
            v-model="allData.bp22a_lock"
            :width="60"
            :active-value="1"
            :inactive-value="0"
            active-color="#13ce66"
    ...
    <el-row type="flex" class="row-bg" justify="center">
      ...
      <el-col :span="6">
        <div class="grid-content bg-purple">液位低低限</div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-input
            :disabled="!ISAUTH.isAUth(['ROOT', 'DATA:ADMIN', 'DATA:UPDATE'])"
            v-model="allData.LTLL"
            @focus="getInputFocus($event)"
