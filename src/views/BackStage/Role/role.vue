        ...
        >
          ...
          <el-form-item>
            <el-button size="medium" type="primary" @click="searchHandle()"
              >查询</el-button
            >
            <el-button size="medium" type="primary" @click="addHandle()">
              新增
            </el-button>
            <el-button size="medium" type="danger" @click="deleteHandle()">
              批量删除
            </el-button>
          </el-form-item>
        </el-form> -->
...
export default {
  ...
  methods: {
    ...
    updateHandle: function (id, systemic) {
      console.log("修改角色的函数");
      console.log("修改角色的函数", id, systemic);
      this.addOrUpdateVisible = true;
      this.$nextTick(() => {
